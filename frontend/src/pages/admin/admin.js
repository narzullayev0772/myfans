        ...
        <div className="account">
            ...
            <div className="account-info">
                <div className="input-wrap">
                    <img className="account-img" id="img" src={src} alt="" />
                    <input className="input" onChange={handleImg} type="file" accept=".png,.jpg" />
                </div>
                ...
                <div className="password">
                    <input type={bool ? "password":"text"}  className="input-text" placeholder="Parol"/>
                    <span onClick={toggleParol} className="checkbox">
                        🔒
                        </span>
                    </div>
                </div>
